...
import { ScrollView, View, Text, StyleSheet, Pressable, LayoutAnimation, UIManager, Platform, TouchableOpacity, ActivityIndicator } from 'react-native';
  ...
  return (
    <View style={styles.container}>
        ...
        <Card containerStyle={{ marginBottom: theme.spacing.s }}>
                            <PayDisplay
                                onHelpPress={() => openDetailModal('Pay Display Summary')}                annualPay={annualPay}
