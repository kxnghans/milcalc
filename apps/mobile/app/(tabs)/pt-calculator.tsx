...
import { useCalculatorState, usePtCalculatorState, useTheme } from "@repo/ui";
...
import CardioComponent from "../../components/PtCalculator/CardioComponent";
import CoreComponent from "../../components/PtCalculator/CoreComponent";
...
import StrengthComponent from "../../components/PtCalculator/StrengthComponent";
...
export default function PTCalculator() {
  ...
  const [startedWithBlankProfile, setStartedWithBlankProfile] =
  ...
  const {
    ...
    altitudeData,
  } = usePtCalculatorState(age, gender, "normal", (data) =>
