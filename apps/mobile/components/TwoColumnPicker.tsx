...
import { getAlphaColor, NeumorphicInset, PillButton, useTheme } from "@repo/ui";
          ...
          <View style={styles.pressableInput}>
            <Text
              style={[
                ...
                (!selectedValue || selectedValue === "initial") &&
                  styles.placeholderText,
                !!error && (styles.errorText as TextStyle),
              ]}
            >
              {getDisplayText()}
            </Text>
