...
interface PayDemographicsProps {
  ...
  mhaData: Record<string, { label: string; value: string | number | null }[]> | null;
  mha: string;
  ...
  mhaError: unknown;
  state: string;
  disabilityPickerData: Record<string, { label: string; value: string | number | null }[]> | null;
  vaDependencyStatus: string | null;
  handleDisabilityChange: (value: string | number | null, primary: string) => void;
