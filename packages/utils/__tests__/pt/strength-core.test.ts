...
describe("Mid-range score spot checks (exact CSV values)", () => {
  ...
  it("Male 55-59: push_ups_1min 14 reps = 2.5 pts", () => {
    const r = getScoreForExercise(std("Male", "55-59"), "push_ups_1min", {
      reps: 14,
    });
  ...
  it("Female 60+: situps 26 reps = 12.5 pts", () => {
    const r = getScoreForExercise(std("Female", "60+"), "sit_ups_1min", {
      reps: 26,
    });
...
describe("Forearm Plank Time Scoring", () => {
  ...
  it("Male 25-29: 2:30 = 8.5 pts", () => {
    const r = getScoreForExercise(std("Male", "25-29"), "forearm_plank_time", {
      minutes: 2,
      seconds: 30,
    });
  ...
  it("Male 40-44: 1:30 = 4.0 pts", () => {
    const r = getScoreForExercise(std("Male", "40-44"), "forearm_plank_time", {
      minutes: 1,
      seconds: 30,
    });
  ...
  it("Male 50-54: 1:05 = 2.5 pts (min for age group)", () => {
    const r = getScoreForExercise(std("Male", "50-54"), "forearm_plank_time", {
      minutes: 1,
      seconds: 5,
    });
    expect(r.points).toBeCloseTo(2.5, 1);
