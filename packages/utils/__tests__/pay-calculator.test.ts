...
describe('Pay Calculator', () => {
    ...
    describe('calculatePay', () => {
        ...
        it('should calculate pay correctly for Head of Household in CO', () => {
            const inputs = {
    ...
    describe('calculateDisabilityIncome', () => {
        ...
        it('should return the correct disability income for a veteran with spouse', () => {
            const income = calculateDisabilityIncome('90%', 'veteran with spouse only', mockDisabilityData as any);
