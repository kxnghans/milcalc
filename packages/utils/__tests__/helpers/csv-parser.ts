...
export function parseCSVData() {
  ...
  const files = [
    {
      name: "pt_scoring_cross_leg_reverse_crunch_2min.csv",
      exercise: "cross_leg_reverse_crunch_2min",
      type: "reps",
    },
    // Forearm plank CSV uses 'time' column (e.g. '2:30') as measurement, not reps
    {
      name: "pt_scoring_forearm_plank.csv",
      exercise: "forearm_plank_time",
      type: "time",
    },
    {
      name: "pt_scoring_hand_release_pushups_2min.csv",
      exercise: "hand_release_pushups_2min",
      type: "reps",
    },
    {
      name: "pt_scoring_pushups_1min.csv",
      exercise: "push_ups_1min",
      type: "reps",
    },
    {
      name: "pt_scoring_situps_1min.csv",
      exercise: "sit_ups_1min",
      type: "reps",
    },
    {
      name: "pt_scoring_hamr_shuttles.csv",
  ...
  try {
    ...
    console.warn("Missing pt_altitude_run.csv");
  }
  ...
  try {
    ...
    console.warn("Missing pt_altitude_hamr.csv");
  }
  ...
  try {
    ...
    console.warn("Missing pt_altitude_walk.csv");
  }
